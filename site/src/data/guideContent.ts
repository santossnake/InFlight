...
export interface GuideItem {
  id: string;
  title: string;
  type: 'text' | 'checklist' | 'table' | 'image' | 'mixed' | 'ar5_noc_checklist' | 'ar5_noc_resume';
        ...
        content: {
          ...
          table: {
            ...
            rows: [
              ...
              ['N18', '5100\''],
              ['N19', '5100\''],
              [{text: 'Transition Altitude: 5000FT AMSL', colSpan: 2, center: true, italic: true}]
            ]
          }
        }
      },
        ...
        content: {
          ...
          table: {
            ...
            rows: [
              ...
              ['C23', '2000\''],
              ['C24', '2700\''],
              [{text: 'R73 AREAS', colSpan: 2, bg: '#eee', bold: true, center: true}],
              ['R73CN', '2300\''],
              ['R73CC', '1000\''],
              ['R73CS', '1600\''],
              [{text: 'Transition Altitude: 4000FT AMSL', colSpan: 2, center: true, italic: true}]
            ]
          }
        }
      },
...
**TITAN01, Ota TWR**, roger MAYDAY, wind at Ota 350 degrees 10 knots, QNH 1012.`
  ...
  },
  {
    id: 'AR5_NOC',
    label: 'AR5 NOC',
    title: 'AR5 Normal Operations Checklist',
    items: [
      {
        id: 'ar5-noc-resume',
        title: '0. FLIGHT RESUME',
        type: 'ar5_noc_resume',
        content: {}
      },
      {
        id: 'ar5-noc-pre-flight',
        title: '1. PRE-FLIGHT',
        ...
        content: [
          ...
          { num: '9', item: "Browser", action: "Check local radio settings", redRisk: true },
          { num: '10', item: "VPN", action: "ON", redRisk: true },
          { num: '11', item: "AWS Remote Desktop", action: "Start all (telemetry and OBC)", redRisk: true },
          ...
          { num: '18', item: "Aircraft ON", action: "Critical & Non-Critical", redRisk: true },
          { num: '19', item: "System Initializing", action: "Wait 30 seconds", redRisk: false },
          { num: '20', item: "Initialization", action: "Complete", redRisk: true },
          { num: '21', item: "Flight GCS", action: "Show config editor / load / start selected", redRisk: true },
          { num: '22', item: "Mode", action: "Manual", redRisk: true },
          { num: '23', item: "SPC Ignition Test", action: "Turn OFF and back ON, Check OFF in GCS", redRisk: true },
          { num: '24', item: "Ignition", action: "Ignition ON", redRisk: true },
          { num: '25', item: "Throttle %", action: "<10%", redRisk: false },
          { num: '26a', item: "Accelerometer: Acc X", action: "AR5imu1 Acc X and AR5imu2 Acc X (-100:100, max dif. 50)", redRisk: true },
          { num: '26b', item: "Accelerometer: Acc Y", action: "AR5imu1 Acc Y and AR5imu2 Acc Y (-100:100, max dif. 50)", redRisk: true },
          { num: '26c', item: "Accelerometer: Acc Z", action: "AR5imu1 Acc Z and AR5imu2 Acc Z (-1080:-880)", redRisk: true },
          ...
          { num: '32', item: "Throttle Failsafe", action: "Check autopilot messages", redRisk: true },
          { num: '33a', item: "Magnetometer: Mag X", action: "Run graph AR5imu1 Mag X and AR5imu2 Mag X and check coherent", redRisk: true },
          { num: '33b', item: "Magnetometer: Mag Y", action: "Run graph AR5imu1 Mag Y and AR5imu2 Mag Y and check coherent", redRisk: true },
          { num: '33c', item: "Magnetometer: Mag Z", action: "Run graph AR5imu1 Mag Z and AR5imu2 Mag Z and check coherent", redRisk: true },
          { num: '34a', item: "SPC: Confirm RC OFF", action: "Confirm RC OFF and ON accordingly", redRisk: true },
          { num: '34b', item: "SPC: Confirm screen locked", action: "Confirm screen locked", redRisk: true },
          { num: '35', item: "Satcom Service", action: "ON", redRisk: true },
          { num: '36', item: "RLOS (EMI check)", action: "OK (100%) & RSSI>-15", redRisk: true },
          { num: '37', item: "RLOS-B", action: "OK (100%)", redRisk: true },
          { num: '38', item: "4G", action: "OK (100%)", redRisk: true },
          { num: '39', item: "RSSI Graph", action: "Check ok", redRisk: true },
          { num: '40', item: "SATCOM IRU + Router", action: "ON", redRisk: true },
          { num: '41', item: "Payload", action: "Payload ON", redRisk: true },
          ...
          { num: '57', item: "Pitch Up", action: "Check Elevators Down / Instruments", redRisk: true },
          { num: '58', item: "Roll Right", action: "Check Left Aileron Up/ Right Aileron Down/ Lidar Increase / Instruments", redRisk: true },
          { num: '59', item: "Pitot", action: "Remove cover", redRisk: true },
          { num: '60', item: "Airspeed 1 Test (EMI check)", action: "Elevator Up / Airspeed1 alive", redRisk: true },
          { num: '61', item: "Airspeed 2 Test (EMI check)", action: "Airspeed2 alive", redRisk: true },
          { num: '62', item: "Airspeed 3 Test (EMI check)", action: "Airspeed3 alive", redRisk: true },
          { num: '63', item: "Mode Manual", action: "Change", redRisk: true },
          { num: '64', item: "Weather Conditions", action: "Check and fill “engine start” column of hourly log table", redRisk: true },
          { num: '65', item: "Maximum take-off headwind", action: "Check limits, Register value >>", redRisk: false },
          { num: '66', item: "Maximum take-off crosswind", action: "Check limits, Register value >>", redRisk: false },
          { num: '67', item: "Runway", action: "Check runway for departure", redRisk: true },
          { num: '68', item: "Load Areas", action: "Load NOTAM & Operational Areas", redRisk: true },
          { num: '69a', item: "Routes: Mission Loaded", action: "Mission Loaded", redRisk: true },
          { num: '69b', item: "Routes: Prepare Take-off Set", action: "Prepare Take-off Set", redRisk: true },
          { num: '69c', item: "Routes: Loiter radius min 250m", action: "Loiter radius min 250m", redRisk: true },
          { num: '69d', item: "Routes: CW or CCW", action: "CW or CCW", redRisk: true },
          { num: '69e', item: "Routes: WP radius 100", action: "WP radius 100", redRisk: true },
          { num: '69f', item: "Routes: Prepare Landing Set", action: "Prepare Landing Set", redRisk: true },
          { num: '69g', item: "Routes: LANDING Waypoint Set", action: "LANDING Waypoint Set", redRisk: true },
          { num: '69h', item: "Routes: Check loaded Rally points", action: "Check loaded Rally points", redRisk: true },
          { num: '70', item: "Navigation Lights", action: "ON", redRisk: true },
          { num: '71', item: "Strobe lights", action: "ON", redRisk: true },
          { num: '72', item: "Landing Lights", action: "ON & OFF", redRisk: true },
          { num: '73', item: "Transponder", action: "ON & Standby mode", redRisk: true },
          { num: '74', item: "Request Startup", action: "Permission Granted", redRisk: true },
          { num: '75', item: "EPU", action: "Remove EPU / Close Hatch", redRisk: true },
          ...
          { num: '83a', item: "Ignition tests: CDI 1 OFF", action: "CDI 1 OFF Check TPS increase, 3000rpm", redRisk: true },
          { num: '83b', item: "Ignition tests: CDI 1 ON", action: "CDI 1 ON Check TPS decrease, 3000rpm", redRisk: true },
          { num: '83c', item: "Ignition tests: CDI 3 OFF", action: "CDI 3 OFF Check TPS increase, 3000rpm", redRisk: true },
          { num: '83d', item: "Ignition tests: CDI 3 ON", action: "CDI 3 ON Check TPS decrease, 3000rpm", redRisk: true },
          { num: '83e', item: "Ignition tests: CDI 2 OFF", action: "CDI 2 OFF Check TPS increase, 3000rpm", redRisk: true },
          { num: '83f', item: "Ignition tests: CDI 2 ON", action: "CDI 2 ON Check TPS decrease, 3000rpm", redRisk: true },
          { num: '83g', item: "Ignition tests: CDI 4 OFF", action: "CDI 4 OFF Check TPS increase, 3000rpm", redRisk: true },
          { num: '83h', item: "Ignition tests: CDI 4 ON", action: "CDI 4 ON Check TPS decrease, 3000rpm", redRisk: true },
          { num: '84a', item: "Engine Max RPM Test: RPM #1", action: "(check>5200RPM) Max RPM #1", redRisk: true },
          { num: '84b', item: "Engine Max RPM Test: RPM #2", action: "(check>5200RPM) Max RPM #2", redRisk: true },
          { num: '85', item: "Battery Status", action: "Check Generator & voltage > 27V", redRisk: true },
          { num: '86', item: "Payload Checklist", action: "Complete\nObservations:", redRisk: true },
          { num: '87', item: "Request Taxi", action: "Permission Granted", redRisk: true },
          { num: '88', item: "Wheel Chocks", action: "Removed", redRisk: true },
          { num: '89', item: "Taxi", action: "Clear Taxi", redRisk: true },
          { num: '90', item: "Check Controls", action: "Manual and FBWA", redRisk: true },
          { num: '91', item: "Check Brakes", action: "Manual and FBWA", redRisk: true },
          { num: '92', item: "Check Steering", action: "Manual and FBWA", redRisk: true },
          { num: '93', item: "Tracker", action: "Tracking Aircraft Correctly", redRisk: true },
          { num: '94', item: "Stop on Runway", action: "Set Home Altitude & Set Home Position", redRisk: true },
          { num: '95', item: "Route", action: "Check route altitudes and write to aircraft", redRisk: true },
          { num: '96', item: "GCS Warnings", action: "Waypoint ON, Mode ON, Comms ON, Motor Set ON 1000rpm", redRisk: true },
          { num: '97', item: "General Status", action: "Check", redRisk: true },
          { num: '98', item: "Transponder", action: "ON & Mode ACS", redRisk: true },
          { num: '99', item: "Crew", action: "Clear", redRisk: true },
          { num: '100', item: "Commander", action: "Clear", redRisk: true },
          ...
          { num: '108', item: "SATCOM & Radar On", action: "Radar, Satcom VMBR + ACU", redRisk: true },
          { num: '109', item: "Browser", action: "Check Satcom (IP 192.168.0.1)", redRisk: true },
          { num: '110', item: "GCS Warnings", action: "Battery Set ON 24V, Set Altitude Warning ON (min:200ft)", redRisk: true },
          { num: '111', item: "Ground Steer", action: "Set GROUND_STEER_ALT = 0", redRisk: true },
          { num: '112', item: "SPC", action: "Off", redRisk: true },
          { num: '113', item: "Rally points", action: "Set Rally points", redRisk: true }
        ]
      },
      {
        ...
        content: [
          ...
          { num: '2', item: "Check loiter direction", action: "(CW or CCW)", redRisk: true },
          { num: '3', item: "SATCOM OFF", action: "Satcom VMBR + ACU", redRisk: true },
          { num: '4', item: "Change THR_MIN", action: "Change THR_MIN to 0%", redRisk: true },
          { num: '5', item: "Ground Steer", action: "Set GROUND_STEER_ALT = 5", redRisk: true },
          { num: '6', item: "TRIM_ARSPD_CM", action: "Check value and landing weight", redRisk: true },
          { num: '7', item: "Radar", action: "STDBY", redRisk: true },
          { num: '8', item: "Coms Check", action: "OK", redRisk: true },
          { num: '9', item: "Aircraft", action: "In Sight", redRisk: true },
          { num: '10', item: "SPC Checklist", action: "OK & ON", redRisk: true },
          { num: '11', item: "Brakes", action: "OFF", redRisk: true },
          { num: '12', item: "Lights", action: "ON", redRisk: true },
      ...
      },
      {
        ...
        content: [
          ...
          { num: '28', item: "Post Flight Walk-around", action: "Begin", redRisk: true },
          { num: '29', item: "Time info panel", action: "Stop Mission", redRisk: true },
          { num: '30a', item: "Deactivate areas and return transponder code: Areas", action: "Areas deactivated", redRisk: true },
          { num: '30b', item: "Deactivate areas and return transponder code: Code", action: "Transponder code returned", redRisk: true },
          { num: '31', item: "Video REC", action: "Stop", redRisk: true },
          { num: '32', item: "ATLAS", action: "Download Report", redRisk: true },
          { num: '33', item: "Radar", action: "ON", redRisk: true },
          { num: '34', item: "Download Data", action: "Gimbal & Radar", redRisk: true },
          { num: '35', item: "Comms Manager", action: "Shutdown", redRisk: true },
          { num: '36', item: "Post Flight Walk-around", action: "Complete", redRisk: true },
